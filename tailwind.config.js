  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'rose-gold-gradient': 'linear-gradient(135deg, #e8c5c8 0%, #b76e79 50%, #8c535c 100%)',
        'pastel-gradient': 'linear-gradient(135deg, #fffdfc 0%, #f8dce3 50%, #cfe8ff 100%)',
        'pink-blue-gradient': 'linear-gradient(135deg, #f6c7d7 0%, #cfe8ff 100%)',
      },
    },
  },
  plugins: [],
